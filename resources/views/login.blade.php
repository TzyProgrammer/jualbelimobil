      ...
      <img class="mx-auto my-auto" src="/logo.png" alt="logo" width="200" >
          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <div>
                  ...
                  <button type="submit" class="w-full text-white bg-red-700 hover:bg-red-700 focus:ring-4 focus:outline-1 focus:ring-primary-300 font-medium rounded-full text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Login</button>
