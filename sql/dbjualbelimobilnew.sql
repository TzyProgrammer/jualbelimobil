...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Jun 2024 pada 11.44
...
INSERT INTO `merek_mobil` (`kode_merek`, `merek`, `gambar`) VALUES
(1, 'Toyota', '1719131452.png');
...
INSERT INTO `mobil` (`kode_mobil`, `kode_merek`, `nama_mobil`, `harga_mobil`, `gambar_mobil`, `deskripsi_mobil`) VALUES
(1, 1, 'Avanza 2016', 150000000, '1718987016.jpeg', 'Mobil Keluarga');
...
INSERT INTO `pembeli` (`id_pembeli`, `username`, `password`, `nama_pembeli`, `nomor_hp`, `foto_profil`, `alamat`) VALUES
(2, 'pembeli1', 'pembeli1', 'Pembeli 1', 81234567890, '', ''),
(3, 'Test', 'rahasia', 'Tester', 81234567890, NULL, 'Poltek Batam'),
(4, 'ASDFGHJKL', 'asdfghjkl', 'ASDF', 89876543210, NULL, 'Polibatam'),
(5, 'Hash', '$2y$12$MjfCUukIPLiUhdrCmxSPu./zw/.ryNGBUy/9Qp37tWqAAsIhcuMGu', 'Hasher', 8765432109, NULL, 'Batam Centre'),
(6, 'Hash1', '$2y$12$fWr.aEnDhtruOJrTLvX11OYBus4NtuoeigEngkz5gyOAI9CZ673a2', 'Hashing', 81234567899, '', 'Teluk Tering');
...
--
ALTER TABLE `merek_mobil`
  MODIFY `kode_merek` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `mobil`
--
ALTER TABLE `mobil`
  MODIFY `kode_mobil` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
